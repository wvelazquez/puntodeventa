    ...
    <div class="col-sm-12">
        <div class="connect-sorting">
            ...
            <div class="connect-sorting-content mt-4">
                <div class="card simple-title-task ui-dortable-handle">
                    <div class="card-body">
                ...
                <div class="row justify-content-between mt-5">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        @if ($efectivo>=$total && $total > 0)
                            <button wire:click.prevent="saveSale"  class="btn btn-darkt btn-md btn-block">
                                GUARDAR F9
                            </button>
                        @endif
                    </div>
